		...
		<div>
			...
			<section id="asterisk" className="load-content">
				<div id="welcome">
					<div>
						<h1>
							<u>
								Welcome<span className="period">.</span>
							</u>
						</h1>
					</div>
					<div>
				...
				<span id="popup-container">
					<span id="info-popup">
						<i
							...
							id="popup-close-button" /*onClick="hidePopup()"*/
						></i>
						<span id="controls">
							<h1>
								<u>Controls:</u>
			...
			{/* <section className="scroll-content">
				<div className="page-title">
					<div>
						<h1>
							Hi there<span className="period">.</span>
						</h1>
					</div>
					<div>
				...
				<div className="main-content">
					<div className="intro">
						<p>
							My name is <Link to="/about/">Gaetano Jones</Link>,
							but you can call me Guy.
						</p>
					</div>
					<div>
						<p>I am a Front End Web Developer and UI Designer.</p>
						<p>
							I started my career as a design student, but
							somewhere along the line I decided to be a developer
							too. It turns out I really, <i>really</i>, like
							making things work.
						</p>
						<p>
							As I've mentioned, my professional work is mainly{" "}
							<Link to="/work/">UI and Front End</Link> related
							projects, but as you might have noticed I sometimes
							find myself working on{" "}
							<Link to="/other-stuff/">other stuff</Link>
							too.
						</p>
					</div>
				</div>
